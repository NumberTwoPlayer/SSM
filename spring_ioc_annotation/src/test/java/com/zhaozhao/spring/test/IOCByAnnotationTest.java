...
import com.zhaozhao.spring.controller.UserController;
...
public class IOCByAnnotationTest {
     ...
     * 即使要赋值的属性的属性名作为bean的id匹配某个bean为属性赋值
     ...
     *
     * 注意：若IOC容器中没有任何一个类型匹配的bean，此时抛出异常：NoUniqueBeanDefinitionException
     * 在@Autowired注解中有个属性required，默认值为true，要求必须完成自动装填
