...
import com.zhaozhao.spring.pojo.Clazz;
import com.zhaozhao.spring.pojo.Person;
...
public class IOCByXMLTest {
     ...
     * 若有多个类型匹配的bean，此时抛出的异常：NoUniqueBeanDefinitionException
     * 3、根据bean的id和类型获取
     * 结论：
     * 根据类型来获取bean时，在满足bean唯一性的前提下，
     * 其实只是看：『对象 instanceof 指定的类型』的返回结果，只
     * 要返回的是true就可以认定为和类型匹配，能够获取到。
     *
